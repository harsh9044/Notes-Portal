...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="test.jsp" method="post" class="login100-form validate-form">
					<div class="wrap-input100 validate-input m-b-26" data-validate="It is required to download your Cr's uploaded Notes">
						<span class="label-input100">CR code</span>
						<input class="input100" type="text" name="tablename" placeholder="Enter CR code" >
